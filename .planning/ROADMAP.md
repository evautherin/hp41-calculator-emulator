...
- [ ] 34-02-PLAN.md — 26 op_display_name arms (closes CI break, 4-way invariant item 3) + function_matrix_parity 3-pool partition + phase25_xeq_by_name Stat 1 extension + phase34_modal_flow.rs + phase34_key_ref_includes_stat1.rs + just ci verification (STAT-CLI-01, 03, 04, 05)
