...
fn op_display_name(op: &Op) -> String {
    match op {
        ...
        // ── Phase 36: Stat 1 Pac Univariate (Plan 36-01 + 36-02 Rule 3 unblock) ──
        ...
        // ── Phase 36: Stat 1 Pac Hypothesis Tests ─────────────────────────────────
        Op::SigmaPtst => "\u{03A3}PTST".to_string(),
        Op::SigmaTstat => "\u{03A3}TSTAT".to_string(),
        // ── Phase 36: Stat 1 Pac Nonparam / Chi-Sq Eval / Contingency ─────────────
